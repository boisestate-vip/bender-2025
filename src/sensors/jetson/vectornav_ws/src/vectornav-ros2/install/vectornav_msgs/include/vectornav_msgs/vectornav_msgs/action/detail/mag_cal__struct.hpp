...
#ifndef _WIN32
# define DEPRECATED__vectornav_msgs__action__MagCal_SendGoal_Event __attribute__((deprecated))
#else
# define DEPRECATED__vectornav_msgs__action__MagCal_SendGoal_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct MagCal_SendGoal_Event_
{
  using Type = MagCal_SendGoal_Event_<ContainerAllocator>;

  explicit MagCal_SendGoal_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit MagCal_SendGoal_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<vectornav_msgs::action::MagCal_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<vectornav_msgs::action::MagCal_SendGoal_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<vectornav_msgs::action::MagCal_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<vectornav_msgs::action::MagCal_SendGoal_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<vectornav_msgs::action::MagCal_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<vectornav_msgs::action::MagCal_SendGoal_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<vectornav_msgs::action::MagCal_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<vectornav_msgs::action::MagCal_SendGoal_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__vectornav_msgs__action__MagCal_SendGoal_Event
    std::shared_ptr<vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__vectornav_msgs__action__MagCal_SendGoal_Event
    std::shared_ptr<vectornav_msgs::action::MagCal_SendGoal_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const MagCal_SendGoal_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using MagCal_SendGoal_Event =
  vectornav_msgs::action::MagCal_SendGoal_Event_<std::allocator<void>>;
...
struct MagCal_SendGoal
{
  ...
  using Event = vectornav_msgs::action::MagCal_SendGoal_Event;
};
...
#ifndef _WIN32
# define DEPRECATED__vectornav_msgs__action__MagCal_GetResult_Event __attribute__((deprecated))
#else
# define DEPRECATED__vectornav_msgs__action__MagCal_GetResult_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct MagCal_GetResult_Event_
{
  using Type = MagCal_GetResult_Event_<ContainerAllocator>;

  explicit MagCal_GetResult_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit MagCal_GetResult_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<vectornav_msgs::action::MagCal_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<vectornav_msgs::action::MagCal_GetResult_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<vectornav_msgs::action::MagCal_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<vectornav_msgs::action::MagCal_GetResult_Response_<ContainerAllocator>>>;
  _response_type response;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<vectornav_msgs::action::MagCal_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<vectornav_msgs::action::MagCal_GetResult_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<vectornav_msgs::action::MagCal_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<vectornav_msgs::action::MagCal_GetResult_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__vectornav_msgs__action__MagCal_GetResult_Event
    std::shared_ptr<vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__vectornav_msgs__action__MagCal_GetResult_Event
    std::shared_ptr<vectornav_msgs::action::MagCal_GetResult_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const MagCal_GetResult_Event_ & other) const
  {
    if (this->info != other.info) {
      return false;
    }
...
// alias to use template instance with default allocator
using MagCal_GetResult_Event =
  vectornav_msgs::action::MagCal_GetResult_Event_<std::allocator<void>>;
...
struct MagCal_GetResult
{
  ...
  using Event = vectornav_msgs::action::MagCal_GetResult_Event;
};
