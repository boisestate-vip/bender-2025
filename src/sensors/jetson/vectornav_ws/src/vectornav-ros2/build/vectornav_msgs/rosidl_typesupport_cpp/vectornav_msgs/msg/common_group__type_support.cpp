...
static const _CommonGroup_type_support_symbol_names_t _CommonGroup_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vectornav_msgs, msg, CommonGroup)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vectornav_msgs, msg, CommonGroup)),
  }
};
...
{
  return &::vectornav_msgs::msg::rosidl_typesupport_cpp::CommonGroup_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vectornav_msgs, msg, CommonGroup)() {
  return get_message_type_support_handle<vectornav_msgs::msg::CommonGroup>();
}
