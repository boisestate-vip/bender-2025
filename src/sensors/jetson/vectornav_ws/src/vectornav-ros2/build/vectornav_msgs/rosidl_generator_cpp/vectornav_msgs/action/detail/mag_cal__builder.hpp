...
class Init_MagCal_SendGoal_Event_response
{
public:
  explicit Init_MagCal_SendGoal_Event_response(::vectornav_msgs::action::MagCal_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::vectornav_msgs::action::MagCal_SendGoal_Event response(::vectornav_msgs::action::MagCal_SendGoal_Event::_response_type arg)
  {
...
private:
  ::vectornav_msgs::action::MagCal_SendGoal_Event msg_;
};

class Init_MagCal_SendGoal_Event_request
{
public:
  explicit Init_MagCal_SendGoal_Event_request(::vectornav_msgs::action::MagCal_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_MagCal_SendGoal_Event_response request(::vectornav_msgs::action::MagCal_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_MagCal_SendGoal_Event_response(msg_);
  }
...
class Init_MagCal_SendGoal_Event_info
{
public:
  Init_MagCal_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_MagCal_SendGoal_Event_request info(::vectornav_msgs::action::MagCal_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_MagCal_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::vectornav_msgs::action::MagCal_SendGoal_Event>()
{
  return vectornav_msgs::action::builder::Init_MagCal_SendGoal_Event_info();
}
...
class Init_MagCal_GetResult_Event_response
{
public:
  explicit Init_MagCal_GetResult_Event_response(::vectornav_msgs::action::MagCal_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::vectornav_msgs::action::MagCal_GetResult_Event response(::vectornav_msgs::action::MagCal_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::vectornav_msgs::action::MagCal_GetResult_Event msg_;
};

class Init_MagCal_GetResult_Event_request
{
public:
  explicit Init_MagCal_GetResult_Event_request(::vectornav_msgs::action::MagCal_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_MagCal_GetResult_Event_response request(::vectornav_msgs::action::MagCal_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_MagCal_GetResult_Event_response(msg_);
  }
...
class Init_MagCal_GetResult_Event_info
{
public:
  Init_MagCal_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_MagCal_GetResult_Event_request info(::vectornav_msgs::action::MagCal_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_MagCal_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::vectornav_msgs::action::MagCal_GetResult_Event>()
{
  return vectornav_msgs::action::builder::Init_MagCal_GetResult_Event_info();
}
