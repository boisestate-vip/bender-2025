...
#include "vectornav_msgs/msg/detail/common_group__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // accel, angularrate, deltatheta_dtheta, deltatheta_dvel, imu_accel, imu_rate, magpres_mag, velocity, yawpitchroll
...
using _CommonGroup__ros_msg_type = vectornav_msgs__msg__CommonGroup;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CommonGroup__ros_msg_type * ros_message = static_cast<const _CommonGroup__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: imu_rate
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->imu_rate, cdr))
    {
      return false;
    }
  }

  // Field name: magpres_mag
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->magpres_mag, cdr))
    {
      return false;
    }
  }

  // Field name: magpres_temp
  {
    cdr << ros_message->magpres_temp;
  }

  // Field name: magpres_pres
  {
    cdr << ros_message->magpres_pres;
  }

  // Field name: deltatheta_dtime
  {
  ...
  // Field name: deltatheta_dvel
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->deltatheta_dvel, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _CommonGroup__ros_msg_type * ros_message = static_cast<_CommonGroup__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_vectornav_msgs__msg__CommonGroup(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CommonGroup__ros_msg_type * ros_message = static_cast<const _CommonGroup__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CommonGroup__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vectornav_msgs__msg__CommonGroup(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vectornav_msgs
size_t max_serialized_size_vectornav_msgs__msg__CommonGroup(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vectornav_msgs__msg__CommonGroup;
    is_plain =
      (
...
static size_t _CommonGroup__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vectornav_msgs__msg__CommonGroup(
...
static message_type_support_callbacks_t __callbacks_CommonGroup = {
  "vectornav_msgs::msg",
  "CommonGroup",
...
static rosidl_message_type_support_t _CommonGroup__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CommonGroup,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vectornav_msgs, msg, CommonGroup)() {
  return &_CommonGroup__type_support;
}
