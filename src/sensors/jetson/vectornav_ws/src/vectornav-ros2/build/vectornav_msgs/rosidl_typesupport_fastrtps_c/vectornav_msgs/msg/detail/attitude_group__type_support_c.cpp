...
#include "vectornav_msgs/msg/detail/attitude_group__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // accelned, linearaccelbody, linearaccelned, magned, yawpitchroll, ypru
#include "std_msgs/msg/detail/header__functions.h"  // header
#include "vectornav_msgs/msg/detail/vpe_status__functions.h"  // vpestatus
...
using _AttitudeGroup__ros_msg_type = vectornav_msgs__msg__AttitudeGroup;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AttitudeGroup__ros_msg_type * ros_message = static_cast<const _AttitudeGroup__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: vpestatus
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vectornav_msgs, msg, VpeStatus
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->vpestatus, cdr))
    {
      return false;
    }
  }

  // Field name: yawpitchroll
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  // Field name: accelned
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->accelned, cdr))
    {
      return false;
    }
  }

  // Field name: linearaccelbody
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->linearaccelbody, cdr))
    {
      return false;
    }
  }

  // Field name: linearaccelned
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->linearaccelned, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _AttitudeGroup__ros_msg_type * ros_message = static_cast<_AttitudeGroup__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_vectornav_msgs__msg__AttitudeGroup(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AttitudeGroup__ros_msg_type * ros_message = static_cast<const _AttitudeGroup__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_vectornav_msgs__msg__VpeStatus(
...
static uint32_t _AttitudeGroup__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vectornav_msgs__msg__AttitudeGroup(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vectornav_msgs
size_t max_serialized_size_vectornav_msgs__msg__AttitudeGroup(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: vpestatus
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_vectornav_msgs__msg__VpeStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = vectornav_msgs__msg__AttitudeGroup;
    is_plain =
      (
...
static size_t _AttitudeGroup__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vectornav_msgs__msg__AttitudeGroup(
...
static message_type_support_callbacks_t __callbacks_AttitudeGroup = {
  "vectornav_msgs::msg",
  "AttitudeGroup",
...
static rosidl_message_type_support_t _AttitudeGroup__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AttitudeGroup,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vectornav_msgs, msg, AttitudeGroup)() {
  return &_AttitudeGroup__type_support;
}
