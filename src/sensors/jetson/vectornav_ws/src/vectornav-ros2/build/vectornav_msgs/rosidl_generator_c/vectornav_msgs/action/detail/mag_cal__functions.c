  ...
  vectornav_msgs__action__MagCal_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vectornav_msgs__action__MagCal_Goal * data =
      (vectornav_msgs__action__MagCal_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vectornav_msgs__action__MagCal_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vectornav_msgs__action__MagCal_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vectornav_msgs__action__MagCal_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vectornav_msgs__action__MagCal_Result * data =
      (vectornav_msgs__action__MagCal_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vectornav_msgs__action__MagCal_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vectornav_msgs__action__MagCal_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vectornav_msgs__action__MagCal_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vectornav_msgs__action__MagCal_Feedback * data =
      (vectornav_msgs__action__MagCal_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vectornav_msgs__action__MagCal_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vectornav_msgs__action__MagCal_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vectornav_msgs__action__MagCal_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vectornav_msgs__action__MagCal_SendGoal_Request * data =
      (vectornav_msgs__action__MagCal_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vectornav_msgs__action__MagCal_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vectornav_msgs__action__MagCal_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vectornav_msgs__action__MagCal_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vectornav_msgs__action__MagCal_SendGoal_Response * data =
      (vectornav_msgs__action__MagCal_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vectornav_msgs__action__MagCal_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vectornav_msgs__action__MagCal_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
vectornav_msgs__action__MagCal_SendGoal_Event__init(vectornav_msgs__action__MagCal_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    vectornav_msgs__action__MagCal_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!vectornav_msgs__action__MagCal_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    vectornav_msgs__action__MagCal_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!vectornav_msgs__action__MagCal_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    vectornav_msgs__action__MagCal_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
vectornav_msgs__action__MagCal_SendGoal_Event__fini(vectornav_msgs__action__MagCal_SendGoal_Event * msg)
{
  ...
  // request
  vectornav_msgs__action__MagCal_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  vectornav_msgs__action__MagCal_SendGoal_Response__Sequence__fini(&msg->response);
}
...
vectornav_msgs__action__MagCal_SendGoal_Event__are_equal(const vectornav_msgs__action__MagCal_SendGoal_Event * lhs, const vectornav_msgs__action__MagCal_SendGoal_Event * rhs)
{
  ...
  // request
  if (!vectornav_msgs__action__MagCal_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!vectornav_msgs__action__MagCal_SendGoal_Response__Sequence__are_equal(
  ...
  vectornav_msgs__action__MagCal_SendGoal_Event * output)
{
  ...
  // request
  if (!vectornav_msgs__action__MagCal_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!vectornav_msgs__action__MagCal_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vectornav_msgs__action__MagCal_SendGoal_Event * msg = (vectornav_msgs__action__MagCal_SendGoal_Event *)allocator.allocate(sizeof(vectornav_msgs__action__MagCal_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vectornav_msgs__action__MagCal_SendGoal_Event));
  bool success = vectornav_msgs__action__MagCal_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
vectornav_msgs__action__MagCal_SendGoal_Event__Sequence__init(vectornav_msgs__action__MagCal_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vectornav_msgs__action__MagCal_SendGoal_Event * data = NULL;

  if (size) {
    data = (vectornav_msgs__action__MagCal_SendGoal_Event *)allocator.zero_allocate(size, sizeof(vectornav_msgs__action__MagCal_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vectornav_msgs__action__MagCal_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        vectornav_msgs__action__MagCal_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
vectornav_msgs__action__MagCal_SendGoal_Event__Sequence__fini(vectornav_msgs__action__MagCal_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      vectornav_msgs__action__MagCal_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vectornav_msgs__action__MagCal_SendGoal_Event__Sequence * array = (vectornav_msgs__action__MagCal_SendGoal_Event__Sequence *)allocator.allocate(sizeof(vectornav_msgs__action__MagCal_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vectornav_msgs__action__MagCal_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
vectornav_msgs__action__MagCal_SendGoal_Event__Sequence__destroy(vectornav_msgs__action__MagCal_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vectornav_msgs__action__MagCal_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vectornav_msgs__action__MagCal_SendGoal_Event__Sequence__are_equal(const vectornav_msgs__action__MagCal_SendGoal_Event__Sequence * lhs, const vectornav_msgs__action__MagCal_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vectornav_msgs__action__MagCal_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vectornav_msgs__action__MagCal_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vectornav_msgs__action__MagCal_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vectornav_msgs__action__MagCal_SendGoal_Event * data =
      (vectornav_msgs__action__MagCal_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vectornav_msgs__action__MagCal_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vectornav_msgs__action__MagCal_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!vectornav_msgs__action__MagCal_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
  ...
  vectornav_msgs__action__MagCal_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vectornav_msgs__action__MagCal_GetResult_Request * data =
      (vectornav_msgs__action__MagCal_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vectornav_msgs__action__MagCal_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vectornav_msgs__action__MagCal_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vectornav_msgs__action__MagCal_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vectornav_msgs__action__MagCal_GetResult_Response * data =
      (vectornav_msgs__action__MagCal_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vectornav_msgs__action__MagCal_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vectornav_msgs__action__MagCal_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
vectornav_msgs__action__MagCal_GetResult_Event__init(vectornav_msgs__action__MagCal_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    vectornav_msgs__action__MagCal_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!vectornav_msgs__action__MagCal_GetResult_Request__Sequence__init(&msg->request, 0)) {
    vectornav_msgs__action__MagCal_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!vectornav_msgs__action__MagCal_GetResult_Response__Sequence__init(&msg->response, 0)) {
    vectornav_msgs__action__MagCal_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
vectornav_msgs__action__MagCal_GetResult_Event__fini(vectornav_msgs__action__MagCal_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  vectornav_msgs__action__MagCal_GetResult_Request__Sequence__fini(&msg->request);
  // response
  vectornav_msgs__action__MagCal_GetResult_Response__Sequence__fini(&msg->response);
}
...
vectornav_msgs__action__MagCal_GetResult_Event__are_equal(const vectornav_msgs__action__MagCal_GetResult_Event * lhs, const vectornav_msgs__action__MagCal_GetResult_Event * rhs)
{
  ...
  // request
  if (!vectornav_msgs__action__MagCal_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!vectornav_msgs__action__MagCal_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  vectornav_msgs__action__MagCal_GetResult_Event * output)
{
  ...
  // request
  if (!vectornav_msgs__action__MagCal_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!vectornav_msgs__action__MagCal_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vectornav_msgs__action__MagCal_GetResult_Event * msg = (vectornav_msgs__action__MagCal_GetResult_Event *)allocator.allocate(sizeof(vectornav_msgs__action__MagCal_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vectornav_msgs__action__MagCal_GetResult_Event));
  bool success = vectornav_msgs__action__MagCal_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
vectornav_msgs__action__MagCal_GetResult_Event__Sequence__init(vectornav_msgs__action__MagCal_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vectornav_msgs__action__MagCal_GetResult_Event * data = NULL;

  if (size) {
    data = (vectornav_msgs__action__MagCal_GetResult_Event *)allocator.zero_allocate(size, sizeof(vectornav_msgs__action__MagCal_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vectornav_msgs__action__MagCal_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        vectornav_msgs__action__MagCal_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
vectornav_msgs__action__MagCal_GetResult_Event__Sequence__fini(vectornav_msgs__action__MagCal_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      vectornav_msgs__action__MagCal_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vectornav_msgs__action__MagCal_GetResult_Event__Sequence * array = (vectornav_msgs__action__MagCal_GetResult_Event__Sequence *)allocator.allocate(sizeof(vectornav_msgs__action__MagCal_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vectornav_msgs__action__MagCal_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
vectornav_msgs__action__MagCal_GetResult_Event__Sequence__destroy(vectornav_msgs__action__MagCal_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vectornav_msgs__action__MagCal_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vectornav_msgs__action__MagCal_GetResult_Event__Sequence__are_equal(const vectornav_msgs__action__MagCal_GetResult_Event__Sequence * lhs, const vectornav_msgs__action__MagCal_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vectornav_msgs__action__MagCal_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vectornav_msgs__action__MagCal_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vectornav_msgs__action__MagCal_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vectornav_msgs__action__MagCal_GetResult_Event * data =
      (vectornav_msgs__action__MagCal_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vectornav_msgs__action__MagCal_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vectornav_msgs__action__MagCal_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!vectornav_msgs__action__MagCal_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
  ...
  vectornav_msgs__action__MagCal_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vectornav_msgs__action__MagCal_FeedbackMessage * data =
      (vectornav_msgs__action__MagCal_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vectornav_msgs__action__MagCal_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vectornav_msgs__action__MagCal_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
