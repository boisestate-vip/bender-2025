...
#include "vectornav_msgs/msg/detail/time_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vectornav_msgs::msg::TimeStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vectornav_msgs::msg::TimeStatus & ros_message)
{
  // Member: time_ok
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vectornav_msgs::msg::TimeStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vectornav_msgs::msg::TimeStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vectornav_msgs::msg::TimeStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TimeStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vectornav_msgs::msg::TimeStatus *>(
...
static size_t _TimeStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TimeStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TimeStatus__callbacks = {
  "vectornav_msgs::msg",
  "TimeStatus",
...
static rosidl_message_type_support_t _TimeStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TimeStatus__callbacks,
...
{
  return &vectornav_msgs::msg::typesupport_fastrtps_cpp::_TimeStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vectornav_msgs, msg, TimeStatus)() {
  return &vectornav_msgs::msg::typesupport_fastrtps_cpp::_TimeStatus__handle;
}
