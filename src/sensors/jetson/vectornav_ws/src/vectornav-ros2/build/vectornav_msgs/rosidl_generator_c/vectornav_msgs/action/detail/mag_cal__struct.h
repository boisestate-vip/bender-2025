...
enum
{
  vectornav_msgs__action__MagCal_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  vectornav_msgs__action__MagCal_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/MagCal in the package vectornav_msgs.
typedef struct vectornav_msgs__action__MagCal_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  vectornav_msgs__action__MagCal_SendGoal_Request__Sequence request;
  vectornav_msgs__action__MagCal_SendGoal_Response__Sequence response;
} vectornav_msgs__action__MagCal_SendGoal_Event;

// Struct for a sequence of vectornav_msgs__action__MagCal_SendGoal_Event.
typedef struct vectornav_msgs__action__MagCal_SendGoal_Event__Sequence
{
...
enum
{
  vectornav_msgs__action__MagCal_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  vectornav_msgs__action__MagCal_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/MagCal in the package vectornav_msgs.
typedef struct vectornav_msgs__action__MagCal_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  vectornav_msgs__action__MagCal_GetResult_Request__Sequence request;
  vectornav_msgs__action__MagCal_GetResult_Response__Sequence response;
} vectornav_msgs__action__MagCal_GetResult_Event;

// Struct for a sequence of vectornav_msgs__action__MagCal_GetResult_Event.
typedef struct vectornav_msgs__action__MagCal_GetResult_Event__Sequence
{
