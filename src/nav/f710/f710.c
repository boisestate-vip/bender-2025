...
int main(int argc, char ** argv) {
   ...
   if ( (odrive0 = open(argv[1],O_RDWR)) == -1) {
   ...
   if ( (odrive1 = open(argv[2],O_RDWR)) == -1) {
   ...
   if ( (teensy = open(argv[3],O_RDWR)) == -1) {
   ...
   if ( (controller = open(argv[4],O_RDONLY)) == -1) {
